...
const Profile = () => {
	const { profile: profileData, isLoading, error, loadProfile, updateProfile, updateProfileImage } = useProfileStore();
	...
	useEffect(() => {
		autoResize();
	}, [profileData.paragraph, autoResize]);
		...
		<section className='profile-container'>
			<div className='profile-title'>
				<textarea
					...
					spellCheck="false"
				/>
				<PhotoUploader onImageChange={handleImageChange} currentImage={profileData.imageUrl} />
			</div>
			<textarea
				ref={textareaRef}
